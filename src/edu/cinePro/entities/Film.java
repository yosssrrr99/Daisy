...
public class Film {
    ...
    public Film(String nomF, String Genre, boolean Archive, String EtatAcc, int NumRea, String Image, String Description, Timestamp dateDispo) {
        this.nomF = nomF;
        this.Genre = Genre;
    ...
    public String toString() {
        return "Film{" + "idF=" + idF + ", nomF=" + nomF + ", Genre=" + Genre + ", Archive=" + Archive + ", EtatAcc=" + EtatAcc + ", NumRea=" + NumRea + ", Image=" + Image + ", Description=" + Description + ", dateDispo=" + dateDispo + '}';
    }
